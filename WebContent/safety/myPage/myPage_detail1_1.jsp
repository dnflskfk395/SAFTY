						...
						<form action="modify1Ok.jsp" name="frm">
							<input type="hidden" name="bno" value="no_value" />
								...
								<table class="inquiry_Table">
									...
									<tr>
										<th><span>성명</span></th>
										<td><input type="text" name="name" class="modifyInfo" /></td>

									</tr>
									<tr>
										<th><span>생년월일</span></th>
										<td><input type="text" name="birth" class="modifyInfo" /></td>
									...
									<tr class="onetr">
										...
										<td><input type="text" name="password" class="modifyInfo" /></td>

									</tr>
									<tr class="onetr">
										<th><span>휴대폰 번호</span></th>
										<td><input type="text" name="tel" class="modifyInfo" /></td>
