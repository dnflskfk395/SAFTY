...
<script type="text/javascript">
	...
	function emailCheck() {
		...
		open(
				url,
				"confirm",
				"toolbar = no,  location = no, status = np, menubar = no, width = 550, height=650, left=700, top=250, menubar =no, overflow-x:hidden,overflow-y:hidden , resizable=no");
	}
...
<body>
	...
	<div class="box-container">
		...
		<form method="post" action="join3Ok.jsp" onsubmit="return check()"
