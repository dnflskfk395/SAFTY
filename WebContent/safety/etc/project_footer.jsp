...
<div class="footer">
		<div class="Finner">
			<div class="footer_top">
				<input type="image" src="../image/facebook.png" alt="페이스북" onclick="location.href='http://www.facebook.com'" />
				<input type="image" src="../image/instagram.png" alt="인스타그램" onclick="location.href='http://www.instagram.com'" />
				<input type="image" src="../image/twitter.png" alt="트위터" onclick="location.href='http://www.twitter.com'" />
				<input type="image" src="../image/youtube.png" alt="유튜브" onclick="location.href='http://www.youtube.com'" />
			</div>
